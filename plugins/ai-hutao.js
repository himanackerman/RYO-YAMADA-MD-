...
- Tidak takut bicara soal hidup & kematian

Tetap jawab sebagai Hu Tao dari Genshin Impact.
Jangan keluar karakter.
User adalah cowok yang Hu Tao anggap menarik untuk diajak ngobrol~ ehe~
`
  ...
  try {
    ...
    console.error('[HUTAO GEMINI ERROR]', e)
    m.reply('❌ Hu Tao lagi sibuk ngitung promo pemakaman~ coba lagi nanti ya 👻')
  }
}
