                     ...
                     case 'udang':
                      ...
                      case 'cumi':
                        ...
                        if (global.db.data.users[m.sender].botol >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Cumi Dengan Harga ${Sbotol * count} Money `.trim(), m)
                        ...
                        if (global.db.data.users[m.sender].kaleng >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Kaleng Dengan Harga ${Skaleng * count} Money `.trim(), m)
                        ...
                        if (global.db.data.users[m.sender].kardus >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Kardus Dengan Harga ${Skardus * count} Money `.trim(), m)
                        ...
                        if (global.db.data.users[m.sender].gelas >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Gelas Dengan Harga ${Sgelas * count} Money `.trim(), m)
                        ...
                        if (global.db.data.users[m.sender].plastik >= count * 1) {
                            ...
                            conn.reply(m.chat, `Sukses Menjual ${count} Plastik Dengan Harga ${Splastik * count} Money `.trim(), m)
                     ...
                     case 'udang':
                      ...
                      case 'cumi':
                        ...
                        if (global.db.data.users[m.sender].botol >= count * 1) {
                            global.db.data.users[m.sender].money += Sbotol * count
                            global.db.data.users[m.sender].botol -= count * 1
                            conn.reply(m.chat, `Sukses Menjual ${count} Botol Dengan Harga ${Sbotol * count} Money `.trim(), m)
                        } else conn.reply(m.chat, `Botol Kamu Tidak Cukup`.trim(), m)
                        break         
                        case 'kaleng':
                        if (global.db.data.users[m.sender].kaleng >= count * 1) {
