...
let handler = async (m, { conn, text, usedPrefix, command }) => {
  ...
  // gaya karakter Ryo Yamada
  let system = `
Kamu adalah *Ryo Yamada* dari anime *"Bocchi the Rock!"*.
Gaya bicara:
- Cool, flat, deadpan
- Jarang menunjukkan emosi tapi perhatian diam-diam
- Suka berkata jujur to the point
- Kadang menggoda Bocchi dan temannya secara kalem
- Misterius, elegan, tidak banyak bicara, tapi selalu tepat

Selalu balas sebagai Ryo kepada user (cowok). Jangan keluar karakter.
  ...
  try {
    ...
    await conn.sendMessage(m.chat, {
      ...
      contextInfo: {
        externalAdReply: {
          title: "Ryo Yamada AI",
          body: "Ryo sedang menjawab…",
          thumbnailUrl: "https://files.catbox.moe/qmy241.jpg",
